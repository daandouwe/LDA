...
static const char __pyx_k_ndocs[] = "ndocs";
...
static const char __pyx_k_niters[] = "niters";
...
static const char __pyx_k_initialize_chain[] = "_initialize_chain";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_run_gibbs_sampler[] = "_run_gibbs_sampler";
...
static PyObject *__pyx_n_s_initialize_chain;
...
static PyObject *__pyx_n_s_ndocs;
...
static PyObject *__pyx_n_s_run_gibbs_sampler;
...
static PyObject *__pyx_pf_4_lda__initialize_chain(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_matrix, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_z, int __pyx_v_ndocs, int __pyx_v_nwords, int __pyx_v_ntopics); /* proto */
static PyObject *__pyx_pf_4_lda_2_run_gibbs_sampler(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_N, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_z, double __pyx_v_alpha, double __pyx_v_beta, int __pyx_v_niters, int __pyx_v_print_every); /* proto */
...
static int __pyx_f_4_lda_searchsorted(__Pyx_memviewslice __pyx_v_arr, int __pyx_v_length, double __pyx_v_value) {
  int __pyx_v_imin;
  int __pyx_v_imax;
  int __pyx_v_imid;
  int __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_4_lda_1_initialize_chain(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4_lda_1_initialize_chain = {"_initialize_chain", (PyCFunction)__pyx_pw_4_lda_1_initialize_chain, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4_lda_1_initialize_chain(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_initialize_chain (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_matrix,&__pyx_n_s_M,&__pyx_n_s_A,&__pyx_n_s_B,&__pyx_n_s_z,&__pyx_n_s_ndocs,&__pyx_n_s_nwords,&__pyx_n_s_ntopics,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 1); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 2); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 3); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 4); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ndocs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 5); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nwords)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 6); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ntopics)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, 7); __PYX_ERR(0, 31, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_initialize_chain") < 0)) __PYX_ERR(0, 31, __pyx_L3_error)
      }
    ...
    __pyx_v_matrix = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[0]); if (unlikely(!__pyx_v_matrix.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_M = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_M.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[2]); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_B = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[3]); if (unlikely(!__pyx_v_B.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4]); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_ndocs = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_ndocs == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
    __pyx_v_nwords = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_nwords == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
    __pyx_v_ntopics = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_ntopics == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_initialize_chain", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 31, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_lda._initialize_chain", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4_lda__initialize_chain(__pyx_self, __pyx_v_matrix, __pyx_v_M, __pyx_v_A, __pyx_v_B, __pyx_v_z, __pyx_v_ndocs, __pyx_v_nwords, __pyx_v_ntopics);
...
static PyObject *__pyx_pf_4_lda__initialize_chain(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_matrix, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_z, int __pyx_v_ndocs, int __pyx_v_nwords, int __pyx_v_ntopics) {
  int __pyx_v_pair;
  int __pyx_v_count;
  ...
  __Pyx_RefNannySetupContext("_initialize_chain", 0);
 ...
 */
      __pyx_t_5 = __pyx_v_d;
      __pyx_t_6 = __pyx_v_w;
      __pyx_v_count = (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_matrix.data + __pyx_t_5 * __pyx_v_matrix.strides[0]) ) + __pyx_t_6 * __pyx_v_matrix.strides[1]) )));
 ...
 *                     A[d,k] += 1
 */
          __pyx_v_k = ((int)((__pyx_v_ntopics - 1) * (((double)rand()) / ((double)RAND_MAX))));
 ...
 */
          ...
          *((int *) ( /* dim=0 */ (__pyx_v_M.data + __pyx_t_10 * __pyx_v_M.strides[0]) )) += 1;
 ...
 */
          ...
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_11 * __pyx_v_A.strides[0]) ) + __pyx_t_12 * __pyx_v_A.strides[1]) )) += 1;
 ...
 */
          ...
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_13 * __pyx_v_B.strides[0]) ) + __pyx_t_14 * __pyx_v_B.strides[1]) )) += 1;
 ...
 */
          ...
          __pyx_t_19 = __pyx_v_pair;
          __pyx_t_20 = 0;
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_19 * __pyx_v_z.strides[0]) ) + __pyx_t_20 * __pyx_v_z.strides[1]) )) = __pyx_t_15;
          __pyx_t_21 = __pyx_v_pair;
          __pyx_t_22 = 1;
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_21 * __pyx_v_z.strides[0]) ) + __pyx_t_22 * __pyx_v_z.strides[1]) )) = __pyx_t_16;
          __pyx_t_23 = __pyx_v_pair;
          __pyx_t_24 = 2;
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_23 * __pyx_v_z.strides[0]) ) + __pyx_t_24 * __pyx_v_z.strides[1]) )) = __pyx_t_17;
          __pyx_t_25 = __pyx_v_pair;
          __pyx_t_26 = 3;
          *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_25 * __pyx_v_z.strides[0]) ) + __pyx_t_26 * __pyx_v_z.strides[1]) )) = __pyx_t_18;
...
/* Python wrapper */
static PyObject *__pyx_pw_4_lda_3_run_gibbs_sampler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4_lda_2_run_gibbs_sampler[] = "\n    During sampling:\n        d is the document number\n        i is the i-th word in document d\n        w is the word index of the i-th word in document d\n        k is the previous topic assignment of the i-th word in document d\n    ";
static PyMethodDef __pyx_mdef_4_lda_3_run_gibbs_sampler = {"_run_gibbs_sampler", (PyCFunction)__pyx_pw_4_lda_3_run_gibbs_sampler, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4_lda_2_run_gibbs_sampler};
static PyObject *__pyx_pw_4_lda_3_run_gibbs_sampler(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  double __pyx_v_beta;
  int __pyx_v_niters;
  int __pyx_v_print_every;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_run_gibbs_sampler (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_N,&__pyx_n_s_M,&__pyx_n_s_A,&__pyx_n_s_B,&__pyx_n_s_z,&__pyx_n_s_alpha,&__pyx_n_s_beta,&__pyx_n_s_niters,&__pyx_n_s_print_every,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_M)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 1); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 2); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_B)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 3); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_z)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 4); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 5); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_beta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 6); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_niters)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 7); __PYX_ERR(0, 54, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_print_every)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, 8); __PYX_ERR(0, 54, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_run_gibbs_sampler") < 0)) __PYX_ERR(0, 54, __pyx_L3_error)
      }
    ...
    __pyx_v_N = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0]); if (unlikely(!__pyx_v_N.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_M = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_M.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[2]); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_B = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[3]); if (unlikely(!__pyx_v_B.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_z = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4]); if (unlikely(!__pyx_v_z.memview)) __PYX_ERR(0, 54, __pyx_L3_error)
    __pyx_v_alpha = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_alpha == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_beta = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_niters = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_niters == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
    __pyx_v_print_every = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_print_every == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_run_gibbs_sampler", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 54, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("_lda._run_gibbs_sampler", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4_lda_2_run_gibbs_sampler(__pyx_self, __pyx_v_N, __pyx_v_M, __pyx_v_A, __pyx_v_B, __pyx_v_z, __pyx_v_alpha, __pyx_v_beta, __pyx_v_niters, __pyx_v_print_every);
...
static PyObject *__pyx_pf_4_lda_2_run_gibbs_sampler(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_N, __Pyx_memviewslice __pyx_v_M, __Pyx_memviewslice __pyx_v_A, __Pyx_memviewslice __pyx_v_B, __Pyx_memviewslice __pyx_v_z, double __pyx_v_alpha, double __pyx_v_beta, int __pyx_v_niters, int __pyx_v_print_every) {
  ...
  int __pyx_t_48;
  __Pyx_RefNannySetupContext("_run_gibbs_sampler", 0);
 ...
 */
  __pyx_v_ntopics = (__pyx_v_B.shape[0]);
 ...
 */
  __pyx_v_nwords = (__pyx_v_B.shape[1]);
 ...
 */
  __pyx_v_npairs = (__pyx_v_z.shape[0]);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_ntopics); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 */
      ...
      __pyx_t_12 = 0;
      __pyx_t_13 = (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_11 * __pyx_v_z.strides[0]) ) + __pyx_t_12 * __pyx_v_z.strides[1]) )));
      __pyx_t_14 = __pyx_v_pair;
      __pyx_t_15 = 1;
      __pyx_t_16 = (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_14 * __pyx_v_z.strides[0]) ) + __pyx_t_15 * __pyx_v_z.strides[1]) )));
      __pyx_t_17 = __pyx_v_pair;
      __pyx_t_18 = 2;
      __pyx_t_19 = (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_17 * __pyx_v_z.strides[0]) ) + __pyx_t_18 * __pyx_v_z.strides[1]) )));
      __pyx_t_20 = __pyx_v_pair;
      __pyx_t_21 = 3;
      __pyx_t_22 = (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_20 * __pyx_v_z.strides[0]) ) + __pyx_t_21 * __pyx_v_z.strides[1]) )));
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_M.data + __pyx_t_23 * __pyx_v_M.strides[0]) )) -= 1;
 ...
 */
      ...
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_24 * __pyx_v_A.strides[0]) ) + __pyx_t_25 * __pyx_v_A.strides[1]) )) -= 1;
 ...
 */
      ...
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_26 * __pyx_v_B.strides[0]) ) + __pyx_t_27 * __pyx_v_B.strides[1]) )) -= 1;
 ...
 */
        ...
        __pyx_v_theta = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_28 * __pyx_v_A.strides[0]) ) + __pyx_t_29 * __pyx_v_A.strides[1]) ))) + __pyx_v_alpha) / (((*((int *) ( /* dim=0 */ (__pyx_v_N.data + __pyx_t_30 * __pyx_v_N.strides[0]) ))) - 1.0) + (__pyx_v_ntopics * __pyx_v_alpha)));
 ...
 */
        ...
        __pyx_t_32 = __pyx_v_w;
        __pyx_t_33 = __pyx_v_i;
        __pyx_v_phi = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_31 * __pyx_v_B.strides[0]) ) + __pyx_t_32 * __pyx_v_B.strides[1]) ))) + __pyx_v_beta) / ((*((int *) ( /* dim=0 */ (__pyx_v_M.data + __pyx_t_33 * __pyx_v_M.strides[0]) ))) + (__pyx_v_nwords * __pyx_v_beta)));
 ...
 * 
 */
        __pyx_v_cumsum = (__pyx_v_cumsum + (__pyx_v_theta * __pyx_v_phi));
 ...
 */
        ...
        *((double *) ( /* dim=0 */ (__pyx_v_p_z.data + __pyx_t_34 * __pyx_v_p_z.strides[0]) )) = __pyx_v_cumsum;
      }
 ...
 *             M[k] += 1
 */
      __pyx_v_k = __pyx_f_4_lda_searchsorted(__pyx_v_p_z, __pyx_v_ntopics, __pyx_v_r);
 ...
 */
      ...
      *((int *) ( /* dim=0 */ (__pyx_v_M.data + __pyx_t_35 * __pyx_v_M.strides[0]) )) += 1;
 ...
 */
      ...
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_A.data + __pyx_t_36 * __pyx_v_A.strides[0]) ) + __pyx_t_37 * __pyx_v_A.strides[1]) )) += 1;
 ...
 */
      ...
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_38 * __pyx_v_B.strides[0]) ) + __pyx_t_39 * __pyx_v_B.strides[1]) )) += 1;
 ...
 */
      ...
      __pyx_t_13 = __pyx_v_k;
      __pyx_t_40 = __pyx_v_pair;
      __pyx_t_41 = 0;
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_40 * __pyx_v_z.strides[0]) ) + __pyx_t_41 * __pyx_v_z.strides[1]) )) = __pyx_t_22;
      __pyx_t_42 = __pyx_v_pair;
      __pyx_t_43 = 1;
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_42 * __pyx_v_z.strides[0]) ) + __pyx_t_43 * __pyx_v_z.strides[1]) )) = __pyx_t_19;
      __pyx_t_44 = __pyx_v_pair;
      __pyx_t_45 = 2;
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_44 * __pyx_v_z.strides[0]) ) + __pyx_t_45 * __pyx_v_z.strides[1]) )) = __pyx_t_16;
      __pyx_t_46 = __pyx_v_pair;
      __pyx_t_47 = 3;
      *((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_z.data + __pyx_t_46 * __pyx_v_z.strides[0]) ) + __pyx_t_47 * __pyx_v_z.strides[1]) )) = __pyx_t_13;
    }
 ...
 */
    __pyx_t_48 = ((((__pyx_v_step + 1) % __pyx_v_print_every) == 0) != 0);
    if (__pyx_t_48) {
 ...
 */
      __pyx_v_elapsed = (((double)(clock() - __pyx_v_t0)) / ((double)CLOCKS_PER_SEC));
 ...
 *             s0 = <int> (elapsed % 60)
 */
      __pyx_v_h0 = ((int)(__pyx_v_elapsed / 3600.0));
 ...
 */
      __pyx_v_m0 = ((int)fmod((__pyx_v_elapsed / 60.0), 60.0));
 ...
 *             h1 = <int> (eta / 3600)
 */
      __pyx_v_s0 = ((int)fmod(__pyx_v_elapsed, 60.0));
 ...
 *             m1 = <int> ((eta / 60) % 60)
 */
      __pyx_v_eta = (((__pyx_v_niters * __pyx_v_elapsed) / ((double)(__pyx_v_step + 1))) - __pyx_v_elapsed);
 ...
 *             s1 = <int> (eta % 60)
 */
      __pyx_v_h1 = ((int)(__pyx_v_eta / 3600.0));
 ...
 */
      __pyx_v_m1 = ((int)fmod((__pyx_v_eta / 60.0), 60.0));
 ...
 */
      __pyx_v_s1 = ((int)fmod(__pyx_v_eta, 60.0));
 ...
 *                                       step+1, niters, h0, m0, s0, h1, m1, s1);
 */
      fprintf(stderr, ((char const *)"\r| Step %d/%d. | elapsed %dh:%dm:%ds | eta %dh:%dm:%ds | "), (__pyx_v_step + 1), __pyx_v_niters, __pyx_v_h0, __pyx_v_m0, __pyx_v_s0, __pyx_v_h1, __pyx_v_m1, __pyx_v_s1);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_initialize_chain, __pyx_k_initialize_chain, sizeof(__pyx_k_initialize_chain), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_ndocs, __pyx_k_ndocs, sizeof(__pyx_k_ndocs), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_run_gibbs_sampler, __pyx_k_run_gibbs_sampler, sizeof(__pyx_k_run_gibbs_sampler), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_tuple__29 = PyTuple_Pack(15, __pyx_n_s_matrix, __pyx_n_s_M, __pyx_n_s_A, __pyx_n_s_B, __pyx_n_s_z, __pyx_n_s_ndocs, __pyx_n_s_nwords, __pyx_n_s_ntopics, __pyx_n_s_pair, __pyx_n_s_count, __pyx_n_s_rep, __pyx_n_s_d, __pyx_n_s_i, __pyx_n_s_w, __pyx_n_s_k); if (unlikely(!__pyx_tuple__29)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__29);
  __Pyx_GIVEREF(__pyx_tuple__29);
  __pyx_codeobj__30 = (PyObject*)__Pyx_PyCode_New(8, 0, 15, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__29, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lda_pyx, __pyx_n_s_initialize_chain, 31, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__30)) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 *     """
 */
  __pyx_tuple__31 = PyTuple_Pack(32, __pyx_n_s_N, __pyx_n_s_M, __pyx_n_s_A, __pyx_n_s_B, __pyx_n_s_z, __pyx_n_s_alpha, __pyx_n_s_beta, __pyx_n_s_niters, __pyx_n_s_print_every, __pyx_n_s_step, __pyx_n_s_pair, __pyx_n_s_d, __pyx_n_s_i, __pyx_n_s_w, __pyx_n_s_k, __pyx_n_s_ntopics, __pyx_n_s_nwords, __pyx_n_s_npairs, __pyx_n_s_theta, __pyx_n_s_phi, __pyx_n_s_cumsum, __pyx_n_s_r, __pyx_n_s_p_z, __pyx_n_s_t0, __pyx_n_s_elapsed, __pyx_n_s_eta, __pyx_n_s_h0, __pyx_n_s_m0, __pyx_n_s_s0, __pyx_n_s_h1, __pyx_n_s_m1, __pyx_n_s_s1); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__31);
  __Pyx_GIVEREF(__pyx_tuple__31);
  __pyx_codeobj__32 = (PyObject*)__Pyx_PyCode_New(9, 0, 32, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__31, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lda_pyx, __pyx_n_s_run_gibbs_sampler, 54, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__32)) __PYX_ERR(0, 54, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4_lda_1_initialize_chain, NULL, __pyx_n_s_lda); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_initialize_chain, __pyx_t_1) < 0) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     """
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4_lda_3_run_gibbs_sampler, NULL, __pyx_n_s_lda); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_run_gibbs_sampler, __pyx_t_1) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init _lda", 0, __pyx_lineno, __pyx_filename);
    }
